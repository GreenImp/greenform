...
(function($) {
  ...
  // added for compatibility with jQuery 1.6+
  $.fn.attrProp = $.fn.prop || $.fn.attr;
	...
	$.widget("ui.nestedSortable", $.extend({}, $.ui.sortable.prototype, {
		...
		serialize: function(o) {
			...
			$(items).each(function() {
				var res = ($(o.item || this).attrProp(o.attribute || 'id') || '').match(o.expression || (/(.+)[-=_](.+)/));
				var pid = ($(o.item || this).parent(o.listType).parent('li').attrProp(o.attribute || 'id') || '').match(o.expression || (/(.+)[-=_](.+)/));
		...
		toArray: function(o) {
			...
			function _recursiveArray(item, depth, left) {
				...
				id = $(item).attrProp('id').match(o.expression || (/(.+)[-=_](.+)/));

				if (depth === sDepth + 1) pid = 'root';
				else {
					parentItem = $(item).parent(o.listType).parent('li').attrProp('id').match(o.expression || (/(.+)[-=_](.+)/));
					pid = parentItem[2];
				}
